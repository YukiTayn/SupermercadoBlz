...
insert into entregas(id_gerente, id_entregador, id_produto, qtd, dataPedido, dataEntrega, stt) values
    (3,5,3,4, '2018-01-01', '2018-03-04', 1),
    (3,5,3,4, '2018-01-01', '2018-03-04', 1),
    (3,5,3,4, '2018-01-01', '2018-03-04', 1),
    (3,5,3,4, '2018-01-01', '2018-03-04', 1),
    (3,14,3,4, '2018-01-01', '2018-03-04', 1),
    (3,15,3,4, '2018-01-01', '2018-03-04', 1),
    (3,16,3,4, '2018-01-01', '2018-03-04', 1);
insert into entregas(id_gerente, id_entregador, id_produto, qtd, dataPedido, stt) values
	(3,17,3,4, '2018-01-01', 1),
    (3,18,3,4, '2018-01-01', 2),
    (3,19,3,4, '2018-01-01', 2),
    (3,20,3,4, '2018-01-01', 1),
    (3,5,1,1, '2018-01-01', 1);
